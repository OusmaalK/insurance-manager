// src/modules/assistant/IAVoiceAssistant.tsx
          ...
          <CardContent className="p-3">
            ...
            <div className="flex gap-2">
              ...
              <input
                ...
                onKeyPress={(e) => e.key === 'Enter' && transcript && sendMessage(transcript)}
            ...
            <p className="text-xs text-gray-400 text-center mt-2">
              {isListening ? '🎤 Parlez maintenant...' : 'Cliquez sur le microphone pour parler'}
            </p>
          </CardContent>
        )}
      </Card>
